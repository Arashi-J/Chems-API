...
class UserBase(BaseModel):
    ...
    role: str = Field(..., title="Rol del Usuario", description="Los permisos del usuario se asignan de acuerdo al rol.")
...
class UserUpdate(UserBase):
    ...
    role: str | None = Field(None, title="Rol del Usuario", description="Los permisos del usuario se asignan de acuerdo al rol.")
